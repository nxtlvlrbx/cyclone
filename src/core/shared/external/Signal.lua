...
setmetatable(Signal, {
	__index = function(_tb, key)
		-- Commented out so that it will work with our modification of Maid
		-- (Maid tries to see if this has a Disconnect method, and this error
		-- would stop execution because of that)
